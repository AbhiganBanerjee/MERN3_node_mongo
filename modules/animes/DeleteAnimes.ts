...
const delAnimes:any = express.Router();
...
delAnimes.delete("/",async (req:any,res:any):Promise<any>=>{
    ...
    try{
        ...
        const delRes:any = await db.collection("animes").deleteOne({"name":req.query.name});
