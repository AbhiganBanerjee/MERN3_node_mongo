...
var delAnimes = express.Router();
//Get the env properties
dotenv.config();
var url = process.env.MONGO_URI;
//Create a DELETE REST Service on this module
delAnimes.delete("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection("animes").deleteOne({ "name": req.query.name })];
            case 2:
                delRes = _a.sent();
