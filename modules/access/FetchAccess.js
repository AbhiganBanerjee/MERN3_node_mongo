...
var fetchAccess = express.Router();
//Build the GET REST Service 
fetchAccess.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientObj, db, movies, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection("access").find({}).toArray()];
            case 2:
                movies = _a.sent();
                //Validate the result
                if (movies.length > 0) {
