...
const delGalaxies:any = express.Router();
...
delGalaxies.delete("/",async (req:any,res:any):Promise<any>=>{
    ...
    try{
        ...
        const delRes:any = await db.collection("galaxies").deleteOne({"name":req.query.name});
