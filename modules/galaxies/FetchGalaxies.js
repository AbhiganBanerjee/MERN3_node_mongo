...
var fetchGalaxies = express.Router();
//build a GET REST Service for this module
fetchGalaxies.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientObj, db, galaxies, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection("galaxies").find({}).toArray()];
            case 2:
                galaxies = _a.sent();
                //Validate the result
