...
const delMovies:any = express.Router();
...
delMovies.delete("/",async (req:any,res:any):Promise<any>=>{
    ...
    try{
        ...
        const delRes:any = await db.collection("movies").deleteOne({"name":req.query.name});
