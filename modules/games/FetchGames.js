...
var fetchGames = express.Router();
//build a GET REST Service for this module
fetchGames.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientObj, db, games, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection("games").find({}).toArray()];
            case 2:
                games = _a.sent();
                //Validate the result
                if (games.length > 0) {
