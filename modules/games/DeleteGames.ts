...
const delGames:any = express.Router();
...
delGames.delete("/",async (req:any,res:any):Promise<any>=>{
    ...
    try{
        ...
        const delRes:any = await db.collection("games").deleteOne({"name":req.query.name});
