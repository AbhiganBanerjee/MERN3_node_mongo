...
var insertBooks = express.Router();
...
insertBooks.post("/", upload.single("image"), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection("books").insertOne({
                        "id": req.body.id,
                        "name": req.body.name,
