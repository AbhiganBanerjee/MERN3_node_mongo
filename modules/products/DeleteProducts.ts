...
const delProducts:any = express.Router();
...
delProducts.delete("/",async (req:any,res:any):Promise<any>=>{
    ...
    try{
        ...
        const delRes:any = await db.collection("products").deleteOne({"name":req.query.name});
